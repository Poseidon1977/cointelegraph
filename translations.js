...
const translations = {
    tr: {
        ...
        'news_error': 'Haberler yüklenemedi.',
        'Gold (24K)': '24 Ayar Altın',
        'Gold (22K)': '22 Ayar Altın',
        'Gold (14K)': '14 Ayar Altın',
    ...
    ua: {
        ...
        'search_no_results': 'Співпадінь не знайдено',
        'search_crypto': 'Крипто',
        'search_stock': 'Акція',
        'search_commodity': 'Товар',
        'news_error': 'Не вдалося завантажити новини.',
        'Gold (24K)': 'Золото (24K)',
        'Gold (22K)': 'Золото (22K)',
        'Gold (14K)': 'Золото (14K)',
        'Quarter Gold': 'Чверть золота',
        'Half Gold': 'Півзолота',
        'Full Gold': 'Повне золото',
        'unit_pcs': 'шт',
        // Stocks
        'AAPL': 'Apple', 'TSLA': 'Tesla', 'NVDA': 'Nvidia', 'MSFT': 'Microsoft', 'AMZN': 'Amazon',
        'GOOGL': 'Google', 'META': 'Meta', 'NFLX': 'Netflix', 'AMD': 'AMD', 'INTC': 'Intel',
